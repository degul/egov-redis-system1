...
public class EgovSampleController {
	...
	public String session(HttpSession session, @ModelAttribute("searchVO") SampleDefaultVO searchVO, ModelMap model) throws Exception {
		
		TestVO vo = (TestVO) session.getAttribute("userVO");
		if(vo == null) {
			System.out.println("vo == null");
			vo = new TestVO();
			
			Timestamp timestamp = new Timestamp(System.currentTimeMillis());
			vo.setId("testID : " + String.valueOf(timestamp.getTime()));
			vo.setPw("testPW : pwpwpwpddddddddd");
	...
	@RequestMapping(value = "/session2.do")
	public String session2(HttpSession session, @ModelAttribute("searchVO") SampleDefaultVO searchVO, ModelMap model) throws Exception {
		return "sample/session2";
	}
